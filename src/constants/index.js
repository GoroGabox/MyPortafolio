...
const projects = [
  {
    ...
    description:
      "Web-based platform that allows users to register and pay for driving lesson plans.",
    tags: [
      {
        name: "react",
  ...
  {
    name: "Space-Minecraft",
    description:
      "Fully function web game, that allow to create and destroy the terrain, and save the changes in the local memory.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
